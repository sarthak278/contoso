...
var onDefault=function(req, res){
    res.send("<h1>Contoso Pvt. Ltd  </h1>"+
              "<hr/>"+
              "<ol>"+
                    " <li>Contoso is a multinational company has their 12 Offices all over world. They want to deploy business</li>"+
                    " <li>application on public cloud with the help of Platform As A Service</li>"+
                    " <li>.Contoso has public Cloud subscription to use it as Infrastructure as a Service (I-a-a-S) and Platform As</li>"+
             "</ol>");
};
